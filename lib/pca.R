...
##seelcting 7 components from continuous and 8 from categorical
pc_test_cont<-predict(pc1,newdata=A_test[,487:500])
pc_test_cont<-pc_test_cont[,1:7]
#colnames(pc_test_cont)<-c("pc_cont1","pc_cont2","pc_cont3","pc_cont4","pc_cont5","pc_cont6","pc_cont7")

pc_test_cat<-predict(pc2,newdata=A_test[,1:486])
pc_test_cat<-pc_test_cat[,1:8]
#colnames(pc_test_cat)<-c("pc_cat1","pc_cat2","pc_cat3","pc_cat4","pc_cat5","pc_cat6","pc_cat7"
#                    ,"pc_cat8","pc_cat9","pc_cat10","pc_cat11")

##select 7 components from continuous and 8 components from categorical
